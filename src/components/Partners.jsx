  ...
  return (
    <section id="partenaires" className="py-20 text-white">
      <div className="container mx-auto px-4 md:px-16">
        ...
        >
          <h2 className="text-5xl md:text-6xl font-[Montserrat] font-extrabold mb-6 text-orange-500">
        ...
        <div className="relative overflow-hidden">
          ...
          >
            {[...logos, ...logos].map((logo, idx) => (
              <div
                key={idx}
                className="shrink-0 w-28 sm:w-36 md:w-40 h-28 sm:h-36 md:h-40 p-3 flex items-center justify-center transition-transform hover:scale-110 hover:shadow-lg rounded-xl bg-gray-800/20"
              >
                <img
                  src={logo.image}
                  alt={logo.name}
